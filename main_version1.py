...
# ----------------------------------------------------------------------------------------
# | Este codigo es para crear la version con el Explorador de Windows                    |
# |                                                                                      |
# | Esta parte solo se importa                                                           |
# | import tkinter as tk                                                                 |
# | from tkinter.filedialog import askopenfilename                                       |
# | tk.Tk().withdraw() # part of the import if you are not using other tkinter functions |
# |                                                                                      |
# | Esta parte iria en donde se da click para abrir el Explorador de Windows             |
# | fn = askopenfilename()                                                               |
# | print("user chose", fn)                                                              |
# ----------------------------------------------------------------------------------------
...
class PDFSplitter(MDApp):
    ...
    def select_path(self, path):
        ...
        self.root.ids.label_pdf_path.text = str(path)
